    ...
    <div className="surface-card p-5">
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="result-card">
          <p className="text-sm text-ink-600">IRPF anual</p>
          <p className="text-xl font-bold text-red-600">{formatEUR(result.cuota)}</p>
        </div>
        <div className="result-card">
          <p className="text-sm text-ink-600">Tipo efectivo</p>
      ...
      <div className="mt-4 rounded-lg bg-ink-50 p-3">
        <p className="text-sm font-medium text-ink-700 mb-2">Desglose por tramos</p>
